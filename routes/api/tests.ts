...
router.get('/:name/:userId/:randNum', async (req: Request, res: Response) => {
  try {
...
router.get('/:randNum/:userId', async (req: Request, res: Response) => {
...
router.put('/:testName/:questionId', async (req: Request, res: Response) => {
  try {
...
async function getTestNamesContainingString(searchString: string) {
