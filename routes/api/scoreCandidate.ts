...
router.get('/:testName', async (req: Request, res: Response) => {
  try {
...
router.get('/:testname/:randNum', async (req: Request, res: Response) => {
...
// @desc   Delete test
// @access Public
router.delete('/:testName', async (req: Request, res: Response) => {
