...
// Define the type of the topicCounts object
...
async function getRemainingTopicCounts(subjectName: string, topic: string) {
  try {
...
router.get('/unique-topics', async (req: Request, res: Response) => {
