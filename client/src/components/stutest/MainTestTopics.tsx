...
interface Params extends Record<string, string | undefined> {
  checkedTopics: string | undefined;
  checkedSubjects: string | undefined;
  userId: string;
  noofquestions: string;
  test_name: string;
}

const MainTestTopics: React.FC = () => {
  ...
  const { checkedTopics, checkedSubjects, userId, noofquestions } = useParams<Params>();
